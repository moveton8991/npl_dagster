# Архитектура
 ![Arch Overview](img/arch.png)
## Описание архитектуры
Берем данные из s3 кладем по средстам Dagster'а в Clickhouse таблицы raw_... соответственно, далее в том же дагстере в том же потоке, рассчитываем агрегаты и кладем в таблицы ..._agg. От туда Apache SuperSet берет данные для визуализации.
